  ...
  return (
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_.9fr]">
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] bg-navy p-8 text-white shadow-premium">
              ...
              <a href="mailto:ops@jmtshipping.com" className="mt-6 inline-flex rounded-full bg-safety px-6 py-3 font-black text-navy">Email Operations</a>
            </div>
      ...
      <Section eyebrow="Location" title="Chattogram-based support for Bangladesh maritime operations.">
        <div className="flex min-h-[320px] items-center justify-center rounded-[2rem] border border-dashed border-ocean/40 bg-gradient-to-br from-harbor to-white p-8 text-center">
          <div>
